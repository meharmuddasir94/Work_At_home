...
public class FbAdapter3 extends FirestoreRecyclerAdapter<ModelClass1, FbAdapter3.FbViewHolder3> {
    Context context;

    public FbAdapter3(@NonNull FirestoreRecyclerOptions<ModelClass1> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull FbViewHolder3 fbViewHolder1, int i, @NonNull final ModelClass1 modelClass1) {
        ...
        fbViewHolder1.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String f = "Ahmed";
                Intent intent = new Intent(context, open_guestgigs.class);
    ...
    @NonNull
    @Override
    public FbViewHolder3 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FbViewHolder3(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.singlecategory_row, parent, false));
    }

    public class FbViewHolder3 extends RecyclerView.ViewHolder {
        TextView usTV, spTV, ciTV, coTV;
        View view;

        public FbViewHolder3(@NonNull View itemView) {
            super(itemView);
