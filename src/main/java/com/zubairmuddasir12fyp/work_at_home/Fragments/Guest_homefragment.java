...
import com.zubairmuddasir12fyp.work_at_home.FbAdapter4;
...
import com.zubairmuddasir12fyp.work_at_home.guest_seeallcat;
import com.zubairmuddasir12fyp.work_at_home.guestproblem;
import com.zubairmuddasir12fyp.work_at_home.guestproblem2;
...
public class Guest_homefragment extends Fragment {
    ...
    private void initializationVariable() {
        ...
        tv2 = objviewhome.findViewById(R.id.tv2);
        tv2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity().getApplicationContext(), guest_seeallcat.class);
