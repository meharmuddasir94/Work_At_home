...
import com.zubairmuddasir12fyp.work_at_home.ui.main.SectionsPagerAdapter3;
...
public class guest_search extends Fragment {
    ...
    private void intal() {
        SectionsPagerAdapter3 sectionsPagerAdapter3 = new SectionsPagerAdapter3(getActivity().getApplicationContext(), getChildFragmentManager());
