...
import com.zubairmuddasir12fyp.work_at_home.Search_view_page;
import com.zubairmuddasir12fyp.work_at_home.SeeAllCate;
import com.zubairmuddasir12fyp.work_at_home.categoriesss;
    ...
    private void initializationVariable() {
        ...
        tv2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity().getApplicationContext(), SeeAllCate.class);
