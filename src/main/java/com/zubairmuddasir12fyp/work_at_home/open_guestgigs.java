...
public class open_guestgigs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(open_guestgigs.this, guest_member.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(open_guestgigs.this, Guest_Home.class);
