...
public class Guest_signup extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            startActivity(new Intent(Guest_signup.this, Log_in.class));
                            Toast.makeText(Guest_signup.this, "User Registered Successfully", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Guest_signup.this, "Failed to Sign up ", Toast.LENGTH_SHORT).show();
    ...
    public void log(View view) {
        Intent i = new Intent(Guest_signup.this, Log_in.class);
        startActivity(i);
    }
                ...
                objectFirebaseFirestore.collection("Users")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Toast.makeText(Guest_signup.this, "Automatically logging in ", Toast.LENGTH_SHORT).show();
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Guest_signup.this, "F", Toast.LENGTH_SHORT).show();
                            }
                        });

            } else {
                Toast.makeText(Guest_signup.this, "Enter Values", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            Toast.makeText(Guest_signup.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
