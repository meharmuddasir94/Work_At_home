...
public class FbAdapter4 extends FirestoreRecyclerAdapter<ModelClass, FbAdapter4.FbViewHolder> {
    Context context;
     ...
     * @param options
     */
    public FbAdapter4(@NonNull FirestoreRecyclerOptions<ModelClass> options, Context context) {
        super(options);
