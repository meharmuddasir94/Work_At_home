...
public class Avaliable_Devices extends AppCompatActivity {
    Button btn;
    ScrollView sl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avaliable__devices);
    ...
    public void dropdown(View view) {
        startActivity(new Intent(Avaliable_Devices.this, Main2Activity.class));
    ...
    public void glogs(View view) {
        startActivity(new Intent(Avaliable_Devices.this, Login.class));
